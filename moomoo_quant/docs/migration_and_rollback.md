...
The new multi-strategy portfolio starts separately. Trend v1, Quality & Low
Volatility v2 and Risk Parity v1 each receive a dedicated JPY 100,000 virtual
budget. Rejected Mean Reversion, Stress Pullback and Defensive Multi-Factor v1
accounts remain at JPY 0. Each funded strategy records its own baseline without
backfilling a historical virtual fill. This avoids silently splitting the old
budget or assigning one strategy's position to another.
